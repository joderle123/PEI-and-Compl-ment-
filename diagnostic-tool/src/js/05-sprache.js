...
var INFORMANTEN = {
  ...
  erzieherin: { de: 'Erzieherin', deUrteil: 'Urteil der Erzieherin', deIm: 'im Urteil der Erzieherin', fr: 'éducatrice', frPar: 'selon l’éducatrice', frForme: 'version éducatrice', en: 'educator', enBy: 'according to the educator', enForm: 'educator form' },
  erzieher: { de: 'Erzieher', deUrteil: 'Urteil des Erziehers', deIm: 'im Urteil des Erziehers', fr: 'éducateur', frPar: 'selon l’éducateur', frForme: 'version éducateur', en: 'educator', enBy: 'according to the educator', enForm: 'educator form' },
